...
import {
  ascii, copied, expect, installCopyStub, openFresh, projects, reloadApp,
  seedDoc, shapes, shareLink, stubDialogs, test, waitForProjects,
} from './helpers';
...
const SEED_BOX: Shape[] = [{ type: 'box', id: 1, x: 2, y: 2, w: 12, h: 5, text: 'hello' }];
